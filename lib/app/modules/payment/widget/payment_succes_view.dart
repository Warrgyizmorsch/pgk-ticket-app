                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(flex: 2, child: Text('Price', textAlign: TextAlign.center, style: AppTextStyles.caption)),
                                  Expanded(flex: 1, child: Text('Qty', textAlign: TextAlign.center, style: AppTextStyles.caption)),
                                  Expanded(flex: 2, child: Text('Total', textAlign: TextAlign.right, style: AppTextStyles.caption)),
                                ],
                              ),
                              const SizedBox(height: 8),
                              const Divider(color: AppColors.lightDivider, thickness: 1),
                              ...
                              Obx(() {
                                ...
                                return Column(
                                  children: controller.tickets.map((item) => Padding(
                                    padding: const EdgeInsets.only(bottom: 16.0),
                                    child: Row(
                                      children: [
                                        Expanded(
                                          flex: 3,
                                          child: Text(item['name'], style: AppTextStyles.bodySmall.copyWith(fontWeight: FontWeight.w600)),
                                        ),
                                        Expanded(
                                          flex: 2,
                                          child: Text(item['price'].toStringAsFixed(0), textAlign: TextAlign.center, style: AppTextStyles.bodySmall),
                                        ),
                                        Expanded(
                                          flex: 1,
                                          child: Text(item['qty'].toString(), textAlign: TextAlign.center, style: AppTextStyles.bodySmall),
                                        ),
                                        Expanded(
                                          flex: 2,
                                          child: Text(item['total'].toStringAsFixed(2), textAlign: TextAlign.right, style: AppTextStyles.bodySmall),
                                        ),
                                      ],
                                    ),
                                  )).toList(),
